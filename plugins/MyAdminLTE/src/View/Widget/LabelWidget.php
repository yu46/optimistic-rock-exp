...
class LabelWidget implements WidgetInterface
{
     ...
     * @var string
     */
    protected $_requiredLabelTemplate = 'requiredLabel';
    ...
    public function render(array $data, ContextInterface $context): string
    {
        ...
        return $this->_templates->format($this->_labelTemplate, [
            'required' => $data['required'] ? $this->_templates->format($this->_requiredLabelTemplate, []) : '',
            'text' => $data['escape'] ? h($data['text']) : $data['text'],
            'input' => $data['input'],
            'hidden' => $data['hidden'],
            'templateVars' => $data['templateVars'],
            'attrs' => $this->_templates->formatAttributes($data, ['text', 'input', 'hidden', 'required']),
        ]);
    }
